...
```{r}
library(sf)
qld_lga <- strayr::read_absmap("lga2018")%>%
...
## [All time scales agree on an extreme drought in 2019-20 bushfire season]{.r-fit-text}
...
##  {.smaller background-image="figures/gggi-weight.png" background-size="55%" background-position="right"}
